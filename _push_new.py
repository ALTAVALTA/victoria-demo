# -*- coding: utf-8 -*-
"""Деплой _deploy/index.html в ALTAVALTA/victoria-demo: клон, замена, коммит, пуш.
...
COMMIT_MSG = 'Апгрейд: H1-позиционирование, продающие заголовки, галерея, реальные цены, рейтинг 24/7, статус открыто/закрыто, Schema.org, штамп в hero'
