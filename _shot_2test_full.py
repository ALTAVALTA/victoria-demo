# -*- coding: utf-8 -*-
"""Скрин V2 с достаточной высотой (14000px), чтобы футер точно влез."""
...
OUT = r'C:\Users\PORTAL\.openclaw\workspace\screenshots\desktop_2test_full.png'
PORT = 8934
...
try:
    ...
    chrome = subprocess.Popen([
        ...
        '--window-size=1280,14000',
        '--screenshot=' + OUT,
        f'http://127.0.0.1:{PORT}/',
    ], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    chrome.wait(timeout=120)
