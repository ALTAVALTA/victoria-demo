# -*- coding: utf-8 -*-
"""Деплой: только правки заголовков (Реальные работы мастеров, убран 'листайте галерею')."""
...
COMMIT_MSG = 'Текст: заголовок секции работ без ложного обещания клика, убрано "листайте галерею"'
